...
export const Root: React.FC = () => (
  <>
    ...
    <Composition id="Reel" component={Reel} width={1080} height={1920} fps={timeline.fps}
      durationInFrames={frames + COVER_FRAMES} defaultProps={{ variant: "organic" as const, intro3d: false, cover: true }} />
    ...
    <Composition id="Reel3D" component={Reel} width={1080} height={1920} fps={timeline.fps}
      durationInFrames={frames + Math.round(timeline.intro3d.seconds * timeline.fps) + COVER_FRAMES}
