...
- The web source remains `04635425`, verified live with 484 tests / 64 files, TypeScript, lint and fixture SSR checks. Backend football repairs have their own final source/test receipt in the readiness ledger.
...
- Reconcile the complete signed privacy inventory in App Store Connect, verify processing and intended build selection, then apply this package and accurate screenshots. No change to the prior 901 submission is claimed.
