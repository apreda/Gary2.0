...
September 4, updated September 18, 2026. Accountable owner: Adam. This replaces the offer, dates, channel assumptions and execution status in the September 1 launch plan. The implementation handoff records deployment and submission evidence; this document defines the operating decisions.

## Execution and review

The six workstreams have an explicit completion scorecard in [the September 18 execution review](EXECUTION_REVIEW_2026-09-18.md). Implementation is not audience validation. Codex handles authorized implementation, verification and analysis during active work; Adam supplies account access, founder footage and human contact decisions. The [personal-tracking pilot](PERSONAL_TRACKING_PILOT.md) must produce real observations before the integration spending gate is met.
...
## Current production policy — September 18

The latest owner handoffs and [September 18 review](EXECUTION_REVIEW_2026-09-18.md) supersede older runtime details below. Games use Fable first with the authorized account/provider order; props use Sol. The single primary X writer condenses the full rationale. MLB/NFL use every-game selection on the five-minute cron. Ordinary code/email monitoring owns incidents; the deleted Codex posting-failure monitor stays deleted. Preserve the authorized June data/bullpen exceptions and immutable original tickets. Source-copy defects and comparative Winners failures remain launch acceptance items. Monday September 21 was recommended, but Sunday September 20 remains the saved PH schedule.
...
This matches the deployed access rules. Founding access currently has no expiry. Do not replace this with “install before October,” “free this season,” a lifetime marketing promise, or an invented season-end date. Existing free game reasoning, available props, Hub, record and private Book remain free. New purchases after preview use the current pricing page; prices and billing details must agree with checkout. The iOS external purchase link is restricted to the U.S. storefront in the verified candidate. Use [the current release handoff](../../HANDOFF_2026-09-16_CLAUDE_FABLE_5_1.md) and [approval receipt](evidence/apple-approval-2026-09-16.json): **2.25 is approved and public in the US and Canada**, with approval tied to September 8 build 920. Latest documented native candidate is 2.26 (931), whose delivery is unconfirmed; 926 is the last confirmed TestFlight build. The September 16 Billfold handoff records signing-keychain failure; earlier Apple account access requests remain outstanding. Do not repeatedly ask or retry unchanged authentication. The next App Store update requires an incremental version and current materials/device acceptance. Approval does not move the September 20 campaign hold or establish Canadian external-purchase eligibility. No further generic expedite email is needed for the completed review.
