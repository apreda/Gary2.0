...
## Current production policy — September 20

The latest founder instructions and owner handoffs supersede older runtime details below; read `gary2.0/CLAUDE.md` and the September 19 failure-policy/backend handoffs before changing routes. College uses Sol with current conference eligibility. Shared routing uses the authorized subscriptions and configured final fallback; do not restore paid Anthropic/OpenAI adapters or obsolete account restrictions. The primary X writer uses the private Mac subscription worker and full source rationale. MLB/NFL retain every-game selection on the five-minute cron. Ordinary code/email monitoring owns incidents; the deleted AI failure monitor stays deleted. Preserve the June engine with approved bullpen/recent-player-log repairs and immutable original tickets. Three current X samples pass; historical copy defects and two Saturday comparative Winners failures are not erased. Database restart diagnosis remains deferred by Adam. Nine legacy demonstration profiles are excluded from public rankings; they are not audience evidence. [Current evidence](EXECUTION_REVIEW_2026-09-20.md).

## The promise

**Your game. Gary’s take.** The Picks brings game picks and player props; Winners highlights Gary’s best bets; The Hub provides useful stats, trends and matchups. Reasoning supports the picks. The public record lets people judge Gary, and a private Book lets them track their own decisions. Preserve each product’s actual selection history and availability.

Use a matchup with a published pick in any demonstration. The September 14 review found all 28 September 13 games covered (15 MLB and 13 NFL), following 23/60 on September 12 after the reported power loss. One recovered full day is not proof of continuous reliability. Coverage is an operational promise to earn: the September 4 check found scheduled games without generated picks. Avoid “every game, always available” claims until the production report demonstrates that reliability. Hold a slate-wide promotion when the report shows unresolved gaps for games past their scheduled start.
...
This matches the deployed access rules. Founding access currently has no expiry. Do not replace this with “install before October,” “free this season,” a lifetime marketing promise, or an invented season-end date. Existing free game reasoning, available props, Hub, record and private Book remain free. New purchases after preview use the current pricing page; prices and billing details must agree with checkout. The iOS external purchase link is restricted to the U.S. storefront in the verified candidate. **2.25 is approved and public in the US and Canada**, with approval tied to September 8 build 920. The [current release-owner handoff](../../HANDOFF_2026-09-20_CODEBASE_CLEANUP_941.md) and fresh Apple receipts confirm **2.26 (941) in TestFlight**; the old 931 signing block / 926 last-confirmed status is superseded. No public submission was made for 941. Keep exact public-version device acceptance and matching materials separate from delivery. Do not repeatedly ask or retry unchanged authentication. US/Canada public availability does not establish Canadian external-purchase eligibility. No further generic expedite email is needed for the completed review.
