...
|---|---|---|---|
| Thumbnail | [gary-thumbnail.png](exports/gary-thumbnail.png) | 800 × 800 | Unmodified existing `web/public/brand/gary-icon.png`; not a new/generated mascot. |
| 1 | [01-find-your-game.jpg](exports/01-find-your-game.jpg) | 1280 × 720 | Actual September 7 public game board. Explicitly labeled as a dated example. |
...
- [Public board](https://www.betwithgary.ai/picks)
- [Mets at Marlins — September 7, 2026](https://www.betwithgary.ai/picks/mlb/2026-09-07/mets-at-marlins)
- [Public game-pick results](https://www.betwithgary.ai/results)

Suggested image descriptions are embedded as `alt` text in the HTML. Retain the visible historical-example labels when uploading. Do not replace the screenshots with stale `web/public/press/gallery_*.png` files: the public press page explicitly retires those older claims.
