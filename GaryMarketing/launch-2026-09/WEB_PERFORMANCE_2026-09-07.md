...
The later [September 8 Search Console inspection](SEARCH_CONSOLE_2026-09-08.md) records Google's actual sitemap Success, Today indexing confirmation and the separate Article-markup fix/validation request. Those observations supersede the earlier lack of a Google-side fetch receipt; they do not change the dated byte measurements above.
