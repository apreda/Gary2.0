...
3. [X audience selection](HANDOFF_2026-09-12_SOCIAL_AUDIENCE.md): intentional subset, one pick per run, spacing, daily/daypart caps and durable claims.
4. [September 13 launch scorecard](GaryMarketing/launch-2026-09/EXECUTION_REVIEW_2026-09-13.md): all six lanes, current audience evidence, yesterday's coverage gap and today's deployed repair.
5. [Postponement](GaryMarketing/launch-2026-09/LAUNCH_POSTPONEMENT_2026-09-12.md), [runbook](GaryMarketing/launch-2026-09/LAUNCH_RUNBOOK.md) and [completion tracker](GaryMarketing/launch-2026-09/LAUNCH_COMPLETION_TRACKER.md): September 20 campaign hold, September 19 rehearsal, October 1 account cutoff and account/channel dependencies.

## Current release and runtime

Build 920 entered App Review September 8. Build 926 has confirmed TestFlight availability. Signed 929 at `/Volumes/KINGSTON/Gary-2.25-929-Feed.xcarchive` supersedes 927/928, but its owner-recorded upload failed with Xcode account access, exit 70. No newer Apple approval or delivery receipt appeared in September 13's bounded inbox check. Restore existing Apple sessions and inspect the actual review selection before uploading, changing the review build or withdrawing anything. The support follow-up is already sent; do not duplicate it.

Native performance work and tests are changing concurrently in the shared checkout. The latest owner turn was interrupted after changed-code and simulator checks passed; broader unchanged Home/Hub fixtures had compiler timeouts and were not a green full suite. They are not a frozen release or part of this launch-report commit. Do not sweep-stage them or the private Firebase plist. Never read, hash, commit or expose `GoogleService-Info.plist`, `SecretsLocal.swift` or their private archive copies.
