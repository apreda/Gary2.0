...
- [Checked data boundaries and shared fixtures](contracts/README.md)
...
`npm run verify` runs incremental backend lint/types, backend and edge tests,
web tests and web type checking. `npm run smoke:web` runs credential-free fixture pages;
