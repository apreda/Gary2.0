...
**Current availability blocker:** the reliability/recovery tasks observed application REST/SQL timeouts at approximately 10:54–10:55 AM Eastern. Task “Investigate Gary picks on Astra” owns recovery and reports pausing only daily insights. Cause is not established. Earlier healthy checks are historical; do not call production healthy until recovery and the live game/account/Book/Winners/publication journey are verified. No parallel database probes or recovery mutations from this launch task.
