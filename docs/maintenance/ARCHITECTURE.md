...
| Pick discovery, date windows, card stats and storage | `scripts/lib/picks/`; canonical sport selection in `pickRunSports.js` |
| Checked date, ticket, market and response boundaries | `src/contracts/boundaries.d.ts`; documentation and shared fixtures in root `contracts/` |
