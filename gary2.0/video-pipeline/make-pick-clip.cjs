...
vo = 3 to 4 short spoken sentences, casual bettor talking to a friend, ending with: "and it gets graded either way." Use only facts from the rationale. No emojis, no dashes, no hashtags, no hype words.
