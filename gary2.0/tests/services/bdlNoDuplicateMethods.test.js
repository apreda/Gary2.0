...
describe('ballDontLieService object literal', () => {
  it('defines every method name exactly once', () => {
    const here = dirname(fileURLToPath(import.meta.url));
    const src = readFileSync(join(here, '../../src/services/ballDontLieService.js'), 'utf8');
