> **X format — September 13, 2026:** Adam corrected the screenshot labels: use **screenshot 1**, factual sentence → bare pick → second factual sentence. Read [the X format handoff](../HANDOFF_2026-09-13_X_FORMAT.md). Source `831f0b78` is pushed and social-auto-post v112 is live. Both facts are now required; no fitting verbatim pair means skip the tweet. Earlier requests for screenshot 2 were a labeling mix-up.
