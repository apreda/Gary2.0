...
3. Request 2-4 info tokens from the approved list that would meaningfully confirm/deny your take.
...
export async function runHypothesisStage({ gameSummary }) {
  ...
  const sanitized = {
    ...
    requested_tokens: sanitizeTokenRequests(parsed.requested_tokens, sportKey, 4),
