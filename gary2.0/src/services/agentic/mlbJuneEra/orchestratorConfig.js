...
import { MLB_JUNE_BRAIN_MODEL, GAME_FALLBACK_MODELS } from '../orchestrator/orchestratorConfig.js';
...
export const GEMINI_PRO_FALLBACK = GAME_FALLBACK_MODELS.find((m) => m !== MLB_JUNE_BRAIN_MODEL) || MLB_JUNE_BRAIN_MODEL;
