...
// ADAPTED (other sports + import paths): the NCAAB venue service is gone and only NCAAB used it; the services underneath are today's.
...
const getNcaabVenue = null, getH2H = null, getLastFiveGames = null;
...
export { isGameCompleted } from '../../../sharedUtils.js'; // ADAPTED (import paths)
