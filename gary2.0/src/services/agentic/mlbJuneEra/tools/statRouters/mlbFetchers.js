...
} from '../../../../mlbStatsApiService.js'; // ADAPTED (import paths): this folder sits one level deeper than June's; the services underneath are today's
...
export const mlbFetchers = {
  ...
  MLB_LINEUP: async (sport, home, away, season, options) => {
    ...
    if (gamePk) {
      try {
        const { getMlbGameLineups } = await import('../../../../mlbStatsApiService.js'); // ADAPTED (import paths)
