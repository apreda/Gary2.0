/**
 * NFL Props Constitution - Data & Integrity Protocols
 * 
 * This file provides the technical guardrails and data protocols for NFL player prop analysis.
 * Gary uses his native intelligence to perform the actual analysis.
 */

export const NFL_PROPS_CONSTITUTION = `
## NFL PROP DATA PROTOCOLS
...
**FORBIDDEN behaviors:**
- DO NOT invent touchdown counts, yardage totals, or any other player stat.
...
- **GAME SCRIPT**: How do trailing or leading scenarios impact player volume?
- **WEATHER IMPACT**: Stats to verify: [WEATHER]
- **RED ZONE USAGE**: Who gets the looks inside the 5-yard line?
- **DEFENSIVE MATCHUPS**: Consider individual shadowing or specific unit weaknesses.
