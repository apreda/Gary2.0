...
STATS DISCIPLINE — this binds your written rationale, not just your research: ground EVERY number and EVERY specific tactical claim in the real data you were given (the Tale of the Tape and tool/research results). You have NOT watched these teams; your own knowledge or memory of them — including formations, tactical systems, and xG or form figures recalled from prior tournaments or qualifiers — is NOT a source. If a stat shows N/A or a fact is simply not in the data, it is unavailable: do not state a value for it. Concretely: if a team's xG reads N/A, do not write an xG number for them; if no starting XI or formation was provided for this match, do not name one ("5-4-1", "high press", "sits deep" are all fabrications unless the data says so); no invented records, form, or travel/flight/lineup stories. Build the case only from what the data actually shows — you have plenty of real rows (goals for/against, possession, shots, shots on target, form, set pieces) to reason from. If the match has essentially no real stats to work from, you have no basis to make a pick: do not manufacture one.`,
