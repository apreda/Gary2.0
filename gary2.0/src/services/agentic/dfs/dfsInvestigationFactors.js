...
export const DFS_INVESTIGATION_FACTORS = {
  NBA: {
    ...
    RETURNING_PLAYERS: ['GET_TEAM_INJURIES', 'GET_PLAYER_GAME_LOGS'],
    STAT_WINDOW_RELIABILITY: [],  // Synthesis — no direct tool
  ...
  MLB: {
    STARTING_PITCHERS: ['GET_PLAYER_SEASON_STATS', 'GET_PLAYER_GAME_LOGS'],
    LINEUP_ORDER: ['SEARCH_LIVE_NEWS'],
    PARK_FACTORS_WEATHER: ['GET_GAME_ENVIRONMENT', 'SEARCH_LIVE_NEWS'],
    BULLPEN_AVAILABILITY: ['SEARCH_LIVE_NEWS', 'GET_PLAYER_GAME_LOGS'],
    PLATOON_SPLITS: ['GET_PLAYER_SEASON_STATS', 'GET_MATCHUP_DATA'],
    STACKING_ENVIRONMENTS: ['GET_GAME_ENVIRONMENT'],
    GAME_TOTALS: ['GET_GAME_ENVIRONMENT'],
    INJURY_LANDSCAPE: ['GET_TEAM_INJURIES'],
    BREAKING_NEWS: ['SEARCH_LIVE_NEWS']
  }
};
...
export const DFS_GAME_RESEARCH_FACTORS = {
  ...
  NFL: {
    ...
    STACKING_CORRELATION: ['GET_TEAM_USAGE_STATS', 'GET_GAME_ENVIRONMENT'],
    RETURNING_PLAYERS_STAT_WINDOW: ['GET_TEAM_INJURIES', 'GET_PLAYER_GAME_LOGS'],
    WEATHER_CONDITIONS: ['SEARCH_LIVE_NEWS'],
    BREAKING_CONTEXT: ['SEARCH_LIVE_NEWS']
  },
  MLB: {
    STARTING_PITCHER_MATCHUP: ['GET_PLAYER_SEASON_STATS', 'GET_PLAYER_GAME_LOGS'],
    LINEUP_ORDER: ['SEARCH_LIVE_NEWS'],
    PLATOON_SPLITS: ['GET_PLAYER_SEASON_STATS', 'GET_MATCHUP_DATA'],
    PARK_WEATHER: ['GET_GAME_ENVIRONMENT', 'SEARCH_LIVE_NEWS'],
    BULLPEN_STATE: ['SEARCH_LIVE_NEWS', 'GET_PLAYER_GAME_LOGS'],
    GAME_ENVIRONMENT: ['GET_GAME_ENVIRONMENT'],
    STACKING_CORRELATION: ['GET_GAME_ENVIRONMENT'],
    INJURY_ROSTER: ['GET_TEAM_INJURIES', 'SEARCH_LIVE_NEWS'],
    BREAKING_CONTEXT: ['SEARCH_LIVE_NEWS']
  }
};
