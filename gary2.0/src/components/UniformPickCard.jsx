    ...
    >
      ...
      >
        ...
        {!isFlipped && (
          ...
          >
            <div className="w-full h-full bg-white shadow-xl rounded-xl border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-[0_0_15px_rgba(0,0,0,0.3)] relative transform hover:-translate-y-1">
              {/* Gold accent */}
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#d4af37] to-transparent"></div>
              
              {/* Badge */}
              <div className={`absolute top-4 right-4 ${badgeStyle} font-bold py-1 px-3 rounded shadow-md text-xs uppercase tracking-wider`}>
                {badge}
              </div>
              
              {/* Image container with consistent styling */}
              <div className={`w-full h-48 ${getBgColor()} flex items-center justify-center relative overflow-hidden`}>
              ...
              {/* Content area */}
              <div className={`p-5 ${getTextColor()}`}>
              ...
              {isLocked && (
                <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex flex-col items-center justify-center text-white p-8 z-50">
                  ...
                  <h3 className="text-xl font-bold mb-2 text-center">Premium Content</h3>
