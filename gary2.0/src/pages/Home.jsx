            ...
            <div className="w-full mx-auto flex flex-col items-center mt-0 md:mt-8" style={{ paddingLeft: "0", paddingRight: "0" }}>
              ...
              <h1 className="mb-10 text-center" style={{ fontSize: "clamp(3.5rem, 6vw, 5rem)", lineHeight: "1.1", letterSpacing: "-0.02em", maxWidth: "920px" }}>
                ...
                <div className="mt-2">
                  ...
                  <span className="italic font-normal text-[#b8953f]">AI Precision</span>
                </div>
              </h1>

              {/* Product description - To the point, 2 lines max */}
              <p className="mb-12 text-white/70 text-center max-w-2xl text-lg">
                Gary combines 40+ years of betting expertise with cutting-edge AI to deliver high-confidence picks that find true value in the market.
              </p>
