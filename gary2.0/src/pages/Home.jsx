      ...
      <div className="relative z-10">
        ...
        <section className="relative py-16 min-h-[110vh] flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-0 z-0" aria-hidden="true">
            ...
            <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full bg-[#bfa142]/10 blur-3xl opacity-20" />
            <div className="absolute -bottom-32 -right-32 w-[600px] h-[600px] rounded-full bg-[#bfa142]/10 blur-3xl opacity-20" />
            
            {/* Thin vertical divider line to give a newspaper column feel */}
            <div className="absolute top-[5%] bottom-[5%] left-1/2 w-px bg-[#bfa142]/20"></div>
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center w-full max-w-5xl px-2 md:px-8">
            ...
            <div className="w-full max-w-lg bg-[#bfa142] py-1 mb-6 transform -rotate-1">
