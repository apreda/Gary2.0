-- Parlay of the Day asks for medium effort (founder, Sep 23 2026: "the correct
-- reasoning needed and no more"). The worker used to force every Opus job to
-- max; it now honors output_config.effort. Body is otherwise 20260923000200.
