-- The installed app reads insight_connections. Project the same validated
-- decisions into its recognized shape in the briefing's transaction, with no
-- second model, threshold tier, or chance of mixing old and new player calls.
-- Keep the already-applied base migration immutable; this replaces its RPC.
...
BEGIN
  ...
  SELECT
    ...
    jsonb_build_object(
      ...
      'team', d->>'team', 'position', d->>'position', 'role', d->>'role',
