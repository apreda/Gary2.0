-- Darts, Sep 23 2026 (founder), later the same afternoon: the NFL's runs against
-- the spread come back ("I actually want to keep the cover-the-spread streaks
-- for NFL"); over/under runs stay gone for every sport. Otherwise as 0900.
--
-- Was:
