export interface SportConfig {
  ...
  retired?: boolean;   // discontinued coverage: history stays, off today's surfaces
}
...
export const SPORTS: SportConfig[] = [
  ...
  { slug: 'nhl', code: 'NHL', name: 'NHL', longName: 'NHL Hockey', accent: '#00A3E0', retired: true },
  { slug: 'nfl', code: 'NFL', name: 'NFL', longName: 'NFL Football', accent: '#22C55E' },
  { slug: 'ncaab', code: 'NCAAB', name: 'NCAAB', longName: 'College Basketball', accent: '#F97316', retired: true },
