...
describe('Book date-filter and open-slip presentation', () => {
  ...
  it.each([
    // The Book's day rolls at 6 AM Eastern (late games), not midnight.
    // Monday → Tuesday: the chosen week already holds both days.
    ['2026-09-08T09:59:59Z', '2026-09-08T10:00:00Z', '2026-09-07', '2026-09-08', true],
    // Saturday → Sunday: a new week begins, the chosen week stays put and the next page opens.
    ['2026-03-08T09:59:59Z', '2026-03-08T10:00:00Z', '2026-03-07', '2026-03-08', false],
    ['2026-11-01T10:59:59Z', '2026-11-01T11:00:00Z', '2026-10-31', '2026-11-01', false],
  ])('keeps the chosen week across the 6 AM Eastern rollover %s while advancing today and preserving open slips', async (before, after, oldDay, newDay, sameWeek) => {
    await load([
