...
export function RecordTicker({ items }: { items: TickerItem[] }) {
  ...
  return (
    <div className="border-y border-white/8 bg-elev/60 py-2">
      <p className="px-4 pb-1.5 font-mono text-[10px] uppercase tracking-[0.08em] text-white/35">
        Recent wins ·{' '}
        <Link href="/results" className="hover:text-white/60">
          Full record &rarr;
        </Link>
      </p>
